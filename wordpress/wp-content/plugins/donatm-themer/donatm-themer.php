<?php 
/**
* Plugin Name: Donatm Themer
* Description: Open Setting, Post Type, Shortcode ... for theme 
* Version: 1.0.2
* Author: Gaviasthemes Team
**/

define( 'GAVIAS_DONATM_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
define( 'GAVIAS_DONATM_PLUGIN_DIR', plugin_dir_path( __FILE__ ) );

if (!function_exists('is_plugin_active')) {
   include_once(ABSPATH . 'wp-admin/includes/plugin.php');
}

class Gavias_Donatm_Themer{
   ...
   public static function instance() {
	...
	public function __construct(){
      ...
      load_plugin_textdomain('donatm-themer', false, 'donatm-themer/languages/');
      $this->gavias_plugin_update();
      add_action('wp_enqueue_scripts', array($this, 'init_scripts_frontend'), 999);
	}
   ...
   public function gaviasthemer_ajax_url(){
	...
	public function include_files(){
      ...
      // Post Types
      require_once(GAVIAS_DONATM_PLUGIN_DIR . 'posttypes/portfolio.php');
      require_once(GAVIAS_DONATM_PLUGIN_DIR . 'posttypes/template.php');

      require_once(GAVIAS_DONATM_PLUGIN_DIR . 'redux/init.php');
      require_once(GAVIAS_DONATM_PLUGIN_DIR . 'includes/functions.php');
		require_once(GAVIAS_DONATM_PLUGIN_DIR . 'includes/hook.php');
      
      require_once(GAVIAS_DONATM_PLUGIN_DIR . 'sample/init.php'); 
      require_once(GAVIAS_DONATM_PLUGIN_DIR . 'widgets/recent_posts.php'); 

      //Template & Layout
      if (function_exists('is_plugin_active') && is_plugin_active( 'elementor/elementor.php' )) {
         require_once(GAVIAS_DONATM_PLUGIN_DIR . 'elementor/init.php'); 
         require_once(GAVIAS_DONATM_PLUGIN_DIR . 'layout/model.php'); 
         require_once(GAVIAS_DONATM_PLUGIN_DIR . 'layout/layout.php');
         require_once(GAVIAS_DONATM_PLUGIN_DIR . 'layout/hook.php');
         require_once(GAVIAS_DONATM_PLUGIN_DIR . 'layout/elementor.php');
         require_once(GAVIAS_DONATM_PLUGIN_DIR . 'layout/frontend.php');
      }

      require_once(GAVIAS_DONATM_PLUGIN_DIR . 'purchase/init.php'); 
	}
   ...
   public function init_scripts_frontend(){
      $css_dir = plugin_dir_url( __FILE__ ).'assets/css';
      wp_enqueue_style('donatm-themer', $css_dir . '/style.css');
   ...
   public function gavias_plugin_update() {
      ...
      Puc_v4_Factory::buildUpdateChecker(
         'http://gaviasthemes.com/plugins/dummy_data/donatm-themer-update-plugin.json',
         __FILE__,
         'donatm-themer'
      );
   }
