...
class Donatm_Themer_Widget_Recent_Posts extends WP_Widget {
   ...
   */
   ...
   public function widget( $args, $instance ) {
      ...
      $default_title = esc_html__( 'Recent Posts', 'donatm-themer' );
            ...
            <li>
               <div class="clearfix post-list-item <?php echo (has_post_thumbnail($recent_post->ID) ? 'has-thumbnail' : 'no-thumbnail' )  ?>">
                  ...
                  <div class="post-content">
                     <?php
                        $comments_number = get_comments_number_text( esc_html__('0 Comments', 'donatm-themer'), esc_html__('1 Comment', 'donatm-themer'), esc_html__('% Comments', 'donatm-themer'), $recent_post->ID);
                        printf( 
...
function donatm_themer_widget_recent_posts(){
   return register_widget('Donatm_Themer_Widget_Recent_Posts');
}

add_action('widgets_init', 'donatm_themer_widget_recent_posts');
