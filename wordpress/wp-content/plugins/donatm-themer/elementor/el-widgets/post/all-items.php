...
class GVAElement_Posts extends GVAElement_Base{
	 ...
	 public function get_title() {
		  return __('Posts All Items', 'donatm-themer');
	 }
	 ...
	 protected function register_controls() {
		  ...
		  $this->add_control( // xx Layout
			...
			$this->add_control(
				...
				[
					 ...
					 'default' => 'carousel',
					 'options' => [
						  'standard'      => __('Standard', 'donatm-themer'),
						  'grid'          => __('Grid', 'donatm-themer'),
						  'carousel'      => __('Carousel', 'donatm-themer'),
						  'small_list'    => __('Small List', 'donatm-themer'),
						  'sticky'        => __('Post Large & List', 'donatm-themer')
					 ]
				]
		  );
		  $this->add_control(
				...
				[
					 ...
					 'options' => [
						  'post-style-1'         => __('Item Post Style I', 'donatm-themer'),
						  'post-style-2'         => __('Item Post Style II', 'donatm-themer'),
						  'post-style-3'         => __('Item Post Style III', 'donatm-themer'),
						  'post-style-4'         => __('Item Post Style IV', 'donatm-themer')
					 ],
					 'condition' => [
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Right List Posts Style', 'donatm-themer'),
		  	...
		  	$this->add_responsive_control(
				'stick_list_padding',
				[
					'label' => __('Padding List Posts', 'donatm-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('Background List Posts', 'donatm-themer'),
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Title Color', 'donatm-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->add_control(
				...
				[
					'label' => __('List Posts Meta Color', 'donatm-themer'),
					'type' => Controls_Manager::COLOR,
					'default' => '',
					'selectors' => [
		  	...
		  	$this->start_controls_section(
				...
				[
					'label' => __('Post Content', 'donatm-themer'),
					'tab'   => Controls_Manager::TAB_STYLE,
					'condition' => [
		  	...
		  	$this->add_responsive_control(
				'post_box_padding',
				[
					'label' => __('Padding Post Content', 'donatm-themer'),
					'type' => Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px', '%' ],
					'selectors' => [
		  ...
		  $this->add_control(
				'post_box_background',
				[
					 'label' => __('Background Post Content', 'donatm-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Title', 'donatm-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title', 'donatm-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->add_control(
				...
				[
					 'label' => __('Color Title Hover', 'donatm-themer'),
					 'type' => Controls_Manager::COLOR,
					 'default' => '',
					 'selectors' => [
		  ...
		  $this->start_controls_section(
				...
				[
					 'label' => __('Post Description', 'donatm-themer'),
					 'tab'   => Controls_Manager::TAB_STYLE,
					 'condition' => [
						  'layout' => ['grid', 'carousel']
					 ],
