...
class GVAElement_Gallery extends GVAElement_Base{
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __('Gallery', 'donatm-themer');
	}
	...
	protected function register_controls() {
      ...
      $repeater->add_control(
         ...
         [
            ...
            'default' => esc_html__('Luxury Interior', 'donatm-themer'),
		...
		$repeater->add_control(
         ...
         [
            ...
            'default' => esc_html__('Hotel', 'donatm-themer'),
            'type'    => Controls_Manager::TEXT,
         ]
     	);
		...
		$this->add_control(
         ...
         [
            ...
            'default'     => array(
                  ...
                  'title' => esc_html__('Food & Health', 'donatm-themer'),
                  'sub_title' => esc_html__('Charity Donate', 'donatm-themer')
              	),
               array(
                  'image'    => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'style-1'           => __( 'Gallery Style 1', 'donatm-themer' ),
					'style-2'           => __( 'Gallery Style 2', 'donatm-themer' )
				],
				'default' => 'style-1',
			]
		);
