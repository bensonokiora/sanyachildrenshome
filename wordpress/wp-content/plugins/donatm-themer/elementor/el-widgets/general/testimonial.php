...
class GVAElement_Testimonial extends GVAElement_Base{
    ...
    public function get_title() {
        return __('Testimonials', 'donatm-themer');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_testimonial',
            [
                'label' => __('Testimonials', 'donatm-themer'),
            ]
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'default' => 'style-1',
                'options' => [
                  'style-1'  => esc_html__('Item Style 01', 'donatm-themer'),
                  'style-2'  => esc_html__('Item Style 02', 'donatm-themer'),
                  'style-3'  => esc_html__('Item Style 03', 'donatm-themer'),
                  'style-4'  => esc_html__('Item Style 04', 'donatm-themer')
                ]
            )
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default'    => [
                    'url' => GAVIAS_DONATM_PLUGIN_URL . 'elementor/assets/images/testimonial.jpg',
                ],
        ...
        $this->add_control(
            'testimonials',
            [
                'label'       => __('Testimonials Content Item', 'donatm-themer'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'title_field' => '{{{ testimonial_name }}}',
                'default'     => array(
                    array(
                        'testimonial_name'     => esc_html__( 'Christine Eve', 'donatm-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'donatm-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Kevin Smith', 'donatm-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'donatm-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Jessica Brown', 'donatm-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'donatm-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'David Anderson', 'donatm-themer' ),
                        'testimonial_job'      => esc_html__( 'Customer', 'donatm-themer' ),
                    ),
                    array(
                        'testimonial_name'     => esc_html__( 'Susan Neill', 'donatm-themer' ),
                        'testimonial_job'      => esc_html__( 'Founder & CEO', 'donatm-themer' ),
                    ),
                ),
            ]
