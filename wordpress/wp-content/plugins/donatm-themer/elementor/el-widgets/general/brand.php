	...
	protected function register_controls() {
		  ...
		  $repeater->add_control(
				...
				[
					 ...
					 'default'    => [
						  'url' => GAVIAS_DONATM_PLUGIN_URL . 'elementor/assets/images/brand.png',
					 ],
		  ...
		  $this->add_control(
				'brands',
				[
					 'label'       => __('Brand Content Item', 'donatm-themer'),
					 'type'        => Controls_Manager::REPEATER,
					 'fields'      => $repeater->get_controls(),
					 'title_field' => '{{{ title }}}',
					 'default'     => array(
						  array(
								'title'  => esc_html__( 'Brand 1', 'donatm-themer' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 2', 'donatm-themer' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 3', 'donatm-themer' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 4', 'donatm-themer' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 5', 'donatm-themer' )
						  ),
						  array(
								'title'  => esc_html__( 'Brand 6', 'donatm-themer' )
						  ),
					 ),
				]
		  );
