...
class GVAElement_Post_Name extends GVAElement_Base{
	...
	public function get_title(){
		return esc_html__('Post Title', 'donatm-themer');
	}
	...
	protected function register_controls(){
		...
		$this->add_control(
			'html_tag',
			[
				'label' => esc_html__('Tag', 'donatm-themer'),
				'type' => Controls_Manager::SELECT,
				'options' => [
				  	'div' => esc_html__('DIV', 'donatm-themer'),
				  	'h1' => esc_html__('H1', 'donatm-themer'),
				  	'h2' => esc_html__('H2', 'donatm-themer'),
				  	'h3' => esc_html__('H3', 'donatm-themer'),
				  	'h4' => esc_html__('H4', 'donatm-themer'),
				  	'h5' => esc_html__('H5', 'donatm-themer'),
				],
				'default' => 'h1',
			]
		);
