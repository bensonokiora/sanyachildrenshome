...
class GVAElement_Cart_Box extends GVAElement_Base {  
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'GVA Cart Box', 'donatm-themer' );
	}
	...
	protected function register_controls() {
      ...
      $this->add_responsive_control(
		...
		$this->add_control(
            ...
            'selectors' => [
               '{{WRAPPER}} .gsc-cart-box .mini-cart-header .mini-cart .icon-cart' => 'border-color: {{VALUE}};color: {{VALUE}}',  
            ]
			]
		);
		$this->add_control(
			'number_color',
			[
				'label' => __( 'Number Color', 'donatm-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
		...
		$this->add_control(
			'number_background',
			[
				'label' => __( 'Number Background', 'donatm-themer' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
