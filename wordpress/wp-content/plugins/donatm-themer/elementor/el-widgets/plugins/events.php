...
class GVAElement_Events extends GVAElement_Base{
	...
	public function get_title() {
		return __('GVA Events', 'donatm-themer');
	}
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'event_start_date' => __( 'Event Start Date', 'donatm-themer' ),
		...
		$this->add_control( // xx Layout
		 ...
		 $this->add_control(
			...
			[
				...
				'default' => 'list',
				'options' => [
					'list'      	=> __( 'List', 'donatm-themer' ),
					'carousel'  	=> __( 'Carousel', 'donatm-themer' ),
					'grid'      	=> __( 'Grid', 'donatm-themer' ),
					'accordion'		=> __( 'Accordion', 'donatm-themer' )
				]
			]
		);
		$this->add_control(
			...
			[
				...
				'options' => [
					'event'       => __( 'Event Item Style 1', 'donatm-themer' ),
					'event-1'     => __( 'Event Item Style 2', 'donatm-themer' ),
					'event-2'     => __( 'Event Item Style 3', 'donatm-themer' ),
					'event-3'     => __( 'Event Item Style 4', 'donatm-themer' )
				],
				'default' => 'event-1',
			]
		);
