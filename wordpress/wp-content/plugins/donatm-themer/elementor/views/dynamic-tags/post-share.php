<?php
   ...
   $post_title = $donatm_post->post_title;
   $post_permalink = get_permalink($post_id);
?>

<div class="donatm-post-share <?php echo $settings['style'] ?>">
   
   <?php if($style == 'style-2' || $style == 'style-3'){ ?>
      <div class="share-button">
         <a href="#" class="btn-control-share btn-white-icon">
            <i class="fas fa-share"></i><?php echo esc_html__('Share', 'donatm-themer') ?>
         </a>
      </div>
   ...
   <?php } ?>
      ...
      <ul class="social-networks-post clearfix">  
         <li class="title-share"><?php echo esc_html__( "Share This Post: ", "donatm-themer" ) ?></li>
         <li class="facebook">
