<?php
	...
	$this->add_render_attribute('wrapper', 'class', ['gva-givewp-grid clearfix gva-archive-givewp']);
	...
	<div class="gva-content-items"> 
		...
		<?php }else{ ?>
			<div class="search-no-results-content">
				<div class="message"><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'donatm-themer' ); ?></div>
				<?php get_search_form() ?>
			</div>
		<?php } ?>   
	</div>
