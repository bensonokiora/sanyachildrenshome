      ...
      <div class="feature-one__wrap">
         <?php 
            if( !empty($settings['image']['url']) ){
               echo '<div class="feature-one__image">';
         ...
         <?php if (!empty($settings['button_url']['url'])){
               echo '<div class="feature-one__action">';
                  echo '<a class="btn-link" ' . $this->get_render_attribute_string( 'button_url' ) . '><i class="dicon-right-arrow-1"></i></a>';
               echo '</div>';
            }
         ?>
      </div> 
