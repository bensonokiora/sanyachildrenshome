...
class GVA_Elementor_Override{
   ...
   public function column_control($obj, $args){
      ...
      $obj->start_controls_section(
         'gva_column_control',
         array(
            'label' => esc_html__( 'Other Settings', 'donatm-themer' ),
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Inner Width', 'donatm-themer'),
   ...
   public function after_row_end( $obj, $args ) {
      ...
      $obj->start_controls_section(
         'gva_section_row',
         array(
            'label' => esc_html__( 'Gavias Extra Settings Row for Header Builder', 'donatm-themer' ),
            'tab'   => Controls_Manager::TAB_LAYOUT,
         )
      );
      ...
      $obj->add_control(
         'row_header_sticky',
         [
            'label'  => esc_html__( 'Sticky Row Settings (Use only for row in header)', 'donatm-themer' ),
      ...
      $obj->add_control(
         '_gva_sticky_menu',
         [
            'label'     => __( 'Sticky Menu Row', 'donatm-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               '' => __( '-- None --', 'donatm-themer' ),
               'gv-sticky-menu' => __( 'Sticky Menu', 'donatm-themer' ),
            ],
            'default'         => '',
            'prefix_class'    => '',
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Sticky Background Color', 'donatm-themer'),
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Sticky Text Color', 'donatm-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Sticky Link Menu Color', 'donatm-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
      ...
      $obj->add_responsive_control(
         ...
         [
            'label'     => __('Sticky Link Menu Hover Color', 'donatm-themer'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
   ...
   public function row_style($obj, $args){
      ...
      $obj->start_controls_section(
         ...
         array(
            'label' => esc_html__( 'Gavias Style Settings', 'donatm-themer' ),
      ...
      $obj->add_control(
         ...
         [
            'label'     => __( 'Style Available', 'donatm-themer' ),
            'type'      => Controls_Manager::SELECT,
            'options'   => [
               ''                 => __( '-- None --', 'donatm-themer' ),
            ],
      ...
      $obj->add_control(
         ...
         [
            ...
            'label_block'  => true,
            'options' => [
               '' => __( '-- Default --', 'donatm-themer' ),
               'theme'         => __( 'Background Color Theme', 'donatm-themer' ),
               'theme-second'  => __( 'Background Color Theme Second', 'donatm-themer' ),
            ],
            'default' => '',
            'prefix_class' => 'bg-row-',
         ]
