      ...
      if($post && $post->post_type === 'gva__template'){
         ...
         if($template_type == 'header_layout'){
            $document->add_control(
               'donatm_header_position',
               [
                  'label'     => esc_html__('Header Position', 'donatm-themer'),
                  'type'      => Controls_Manager::SELECT,
                  'options'   => array(
                     'relative'  => esc_html__('Relative', 'donatm-themer'),
                     'absolute'  => esc_html__('Absolute', 'donatm-themer'),
                  ),
                  'default' => 'relative',
               ]
            );
            $document->add_control(
               ...
               [
                  'label' => esc_html__('Background Black Demo', 'donatm-themer'),
         ...
         if($show_preview){
            $document->add_control(
               'donatm_post_preview',
               [
                  'label'     => esc_html__('Preview Content', 'donatm-themer'),
                  'type'      => Controls_Manager::SELECT,
