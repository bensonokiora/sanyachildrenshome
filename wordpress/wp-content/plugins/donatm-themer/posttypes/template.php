...
class Gavias_Themer_Template{
	...
	public function args_post_type_template(){
		$labels = array(
			'name'               => esc_html__( 'Template', 'donatm-themer' ),
			'singular_name'      => esc_html__( 'Template', 'donatm-themer' ),
			'add_new'            => esc_html__( 'Add Template', 'donatm-themer' ),
			'add_new_item'       => esc_html__( 'Add Template', 'donatm-themer' ),
			'edit_item'          => esc_html__( 'Edit Template', 'donatm-themer' ),
			'new_item'           => esc_html__( 'New Template', 'donatm-themer' ),
			'view_item'          => esc_html__( 'View Template', 'donatm-themer' ),
			'search_items'       => esc_html__( 'Search Template Profiles', 'donatm-themer' ),
			'not_found'          => esc_html__( 'No Template Profiles found', 'donatm-themer' ),
			'not_found_in_trash' => esc_html__( 'No Template Profiles found in Trash', 'donatm-themer' ),
			'parent_item_colon'  => esc_html__( 'Parent Template:', 'donatm-themer' ),
			'menu_name'          => esc_html__( 'Templates & Layout', 'donatm-themer' ),
		);
