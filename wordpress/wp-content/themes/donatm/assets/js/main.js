(function($) {
  	...
  	var GaviasTheme = {
        ...
        if (window.innerWidth > body.clientWidth + 6) {
        	...
        	setTimeout(function(){
          	if($('body').hasClass('donatm-body-loading')){
              $('body').removeClass('donatm-body-loading');
              $('.donatm-page-loading').fadeOut(50);
          	}
      	}, 360);
	 	},
	 	...
	 	menuMobile: function(){
			...
			$( document ).on( 'click', '.control-close-mm', function(e) {
			  	e.preventDefault();
	 	...
	 	megaMenuSize: function(){
	 		if($('.gva-navigation-menu .megamenu-align-fullwidth').length){
		 		$('.gva-navigation-menu .megamenu-align-fullwidth').each(function(e){
		   		...
		   		var i = $(this).closest('.elementor-widget-gva-navigation-menu');
		   		var l = parent.offset().left;
		   		var width = $(window).width() - $(i).offset().left;
		   		//console.log($(parent).offset().left);
		   		m.css({
		   			width: width + 80,
		   			left: -($(parent).offset().left - $(i).offset().left) - 95
		   		});
		   	});
		 	}
	 	},
		...
		scrollTop: function(){
	 	...
	 	campaign: function(){
	 		...
	 		$('.campaign-progress .progress-bar').each(function(){
		...
		other: function(){
			...
			$('.donatm-post-share.style-2 .btn-control-share').on('click', function(e){
				e.preventDefault();
				var wrapper = $(this).parents('.donatm-post-share');
