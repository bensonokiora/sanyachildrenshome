<?php 
   ...
   if(!empty($item_cats) && !is_wp_error($item_cats)){
      foreach((array)$item_cats as $item_cat){
         ...
         $output .= '<a href="'.get_category_link( $item_cat->term_id ).'" title="' . esc_attr( sprintf( esc_attr__( "View all posts in %s", 'donatm' ), $item_cat->name ) ) . '">'.$item_cat->name.'</a>'.$separator;
      }
...
<div class="<?php echo esc_attr($item_classes) ?>">
   <div class="portfolio-two">      
      <div class="portfolio-two__image">
         <a class="portfolio-two__link" href="<?php the_permalink(); ?>">
      ...
      <div class="portfolio-two__content">
         <div class="portfolio-two__content-inner">
            <div class="portfolio-two__category"><?php echo wp_kses($post_category, true) ?></div>
            <h3 class="portfolio-two__title">
               <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
            </h3>
            <span class="portfolio-two__arrow">
               <a class="text-white" href="<?php the_permalink(); ?>"><i class="dicon-right-arrow-1"></i></a>
            </span>
         </div>    
      </div>  
   </div>
