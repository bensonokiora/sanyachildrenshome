 ...
 */
	...
	$columns_lg = donatm_get_option('portfolio_columns_lg', '4');
	$columns_md = donatm_get_option('portfolio_columns_md', '3');
	$columns_sm = donatm_get_option('portfolio_columns_sm', '2');
	$columns_xs = donatm_get_option('portfolio_columns_xs', '1');
?>
	...
	<div class="container">  
		<div class="main-page-content row">
		  	<div class="content-page col-12">      
			 	<div id="wp-content" class="wp-content clearfix pt-50 pb-50">
