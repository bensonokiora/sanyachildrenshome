 ...
 */
   ...
   $columns_lg = donatm_get_option('product_columns_lg', $std_lg);
   $columns_md = donatm_get_option('product_columns_md', $std_md);
   $columns_sm = donatm_get_option('product_columns_sm', $std_sm);
   $columns_xs = donatm_get_option('product_columns_xs', $std_xs);
?>
