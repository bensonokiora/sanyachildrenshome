...
<div class="campaign-four">
	<div class="campaign-four__wrap">
		<div class="campaign-four__image">
			<?php 
				if(isset($data['image']) && $data['image']){ 
					...
					if($image){
						echo '<a href="' . esc_url($data['pagePermalink']) . '" class="campaign-four__link">';
							echo wp_kses($image, true);
						echo '</a>';
					}
				}
			?>
			<a href="<?php echo esc_url($data['pagePermalink']) ?>" class="campaign-four__overlay"></a>
			<div class="campaign-four__btn-donate">
				<?php echo give(RenderDonateButton::class)($campaign->defaultFormId, __('Donate Now', 'donatm')) ?>
			</div>
		</div>

		<div class="campaign-four__content">
			 
	      <h2 class="campaign-four__title">
				<a href="<?php echo esc_url($data['pagePermalink']) ?>">
					<?php echo esc_html($data['title']) ?>
				</a>
			</h2>

			<div class="campaign-progress campaign-four__progress">
	         <div class="progress">
			...
			<div class="campaign-four__information">
				<div class="campaign-four__raised">
	            <span class="campaign-four__raised-label"><?php echo esc_html__('Raised: ', 'donatm') ?></span>
	            <span class="campaign-four__raised-value"><?php echo esc_html($actualFormatted); ?></span>
		      </div>
		      <div class="campaign-four__goal">
		         <span class="campaign-four__goal-label"><?php echo esc_html__('Goal:', 'donatm'); ?></span>
		         <span class="campaign-four__goal-value"><?php echo esc_html($goalFormatted); ?></span>
		      </div>
		   </div>   
