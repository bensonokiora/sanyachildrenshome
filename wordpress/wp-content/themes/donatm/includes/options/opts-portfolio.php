...
Redux::setSection( $opt_name, array(
	'title'   => esc_html__( 'Portfolio Options', 'donatm' ),
	'icon'    => 'el-icon-website',
	'fields'  => array(
		array(
		  	'id'  	=> 'slug_portfolio_post_type',
		  	'type'  	=> 'info',
		  	'raw' 	=> '<h3 style="margin: 0;">' . esc_html__( 'Slug url portfolio post type', 'donatm' ) . '</h3>'
		),
		array(
		  	'id' 			=> 'slug_portfolio',
		  	'type' 		=> 'text',
		  	'title' 		=> esc_html__('Slug Portfolio', 'donatm'),
		  	'default' 	=> 'case'
		),
		array(
		  	...
		  	'type'  	=> 'info',
		  	'icon'  	=> true,
		  	'raw' 	=> '<h3 style="margin: 0;">' . esc_html__( 'Archive/Listing', 'donatm' ) . '</h3>',
		),
		array(
